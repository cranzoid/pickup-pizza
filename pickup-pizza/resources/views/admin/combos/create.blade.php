...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mt-4">Create New Combo</h1>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="number" step="0.01" min="0" class="form-control @error('regular_price') is-invalid @enderror" id="regular_price" name="regular_price" value="{{ old('regular_price') }}">
                                @error('regular_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 product-options" id="options{{ $product->id }}" style="{{ in_array($product->id, old('products', [])) ? '' : 'display: none;' }}">
                                ...
                                <div class="card-body">
                                    <div class="form-check">
                                        <input class="form-check-input upsell-checkbox" type="checkbox" 
                                            ...
                                            {{ in_array($product->id, old('upsell_products', [])) ? 'checked' : '' }}>
