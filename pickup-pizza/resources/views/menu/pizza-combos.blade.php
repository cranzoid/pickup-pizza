...
<div class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <!-- Pop Options -->
            <div class="mb-4 mt-5">
                <h5 class="fw-bold mb-3">Pop Options</h5>
                <div class="row g-2">
                    <div class="col-md-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotalPrice() {
        ...
        // Add third pizza price if selected
        if (document.getElementById('add-third-pizza-yes') && 
            document.getElementById('add-third-pizza-yes').checked) {
            @php
                $thirdPizzaPrice = 0;
                if (strpos($product->name, 'Medium') !== false) {
                    $thirdPizzaPrice = 10.99;
        ...
        // Calculate total price of extra toppings
        if (document.getElementById('add-first-pizza-toppings-yes') && 
            document.getElementById('add-first-pizza-toppings-yes').checked) {
            extraToppingsTotal += updateFirstPizzaExtraToppingCount();
        }
        
        if (document.getElementById('add-second-pizza-toppings-yes') && 
            document.getElementById('add-second-pizza-toppings-yes').checked) {
