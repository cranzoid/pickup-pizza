        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    <h5>PISA Pizza</h5>
                    <p>Delicious pickup-only pizza made with fresh ingredients and care.</p>
                    <div class="mt-3">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><i class="bi bi-clock me-2"></i>Monday - Thursday: 11:00 AM - 9:00 PM</li>
                        <li class="mb-2"><i class="bi bi-clock me-2"></i>Friday - Saturday: 11:00 AM - 10:00 PM</li>
                        <li class="mb-2"><i class="bi bi-clock me-2"></i>Sunday: 12:00 PM - 8:00 PM</li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><i class="bi bi-geo-alt me-2"></i>123 Pizza Lane, Toronto, ON</li>
                        <li class="mb-2"><i class="bi bi-telephone me-2"></i>(416) 555-1234</li>
                        <li class="mb-2"><i class="bi bi-envelope me-2"></i>info@pisapizza.ca</li>
                    </ul>
                </div>
            </div>
