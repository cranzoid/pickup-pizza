...
class TwoLargePizzasComboSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $productId = DB::table('products')->insertGetId([
            ...
            'name' => '2 Large Pizzas Combo',
            'slug' => "two-large-pizzas-combo-{$timestamp}",
            'description' => '2 Large Pizzas (3 toppings each), 3 lbs Wings, 4 Pops, Veggie Sticks, Blue Cheese, Free Dipping Sauce',
            'price' => 53.99,
            'sizes' => json_encode([
                'large' => ['price' => 53.99],
            ]),
            'add_ons' => json_encode([
                'third_pizza' => [
                    'name' => 'Add 3rd Pizza',
                    'description' => 'Add a third large pizza with 3 toppings',
                    'price' => 12.99
                ],
                'garlic_bread' => [
        ...
        echo "Created Two Large Pizzas Combo product\n";
    }
} 