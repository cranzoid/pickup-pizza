...
class TwoMediumPizzasComboSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $productId = DB::table('products')->insertGetId([
            ...
            'name' => '2 Medium Pizzas Combo',
            'slug' => "two-medium-pizzas-combo-{$timestamp}",
            'description' => '2 Medium Pizzas (3 toppings each), 2 lbs Wings, 4 Pops, Veggie Sticks, Blue Cheese, Free Dipping Sauce',
            'price' => 43.99,
            'sizes' => json_encode([
                'medium' => ['price' => 43.99],
            ]),
            'add_ons' => json_encode([
                'third_pizza' => [
                    'name' => 'Add 3rd Pizza',
                    'description' => 'Add a third medium pizza with 3 toppings',
                    'price' => 10.99
                ],
                'garlic_bread' => [
        ...
        echo "Created Two Medium Pizzas Combo product\n";
    }
} 